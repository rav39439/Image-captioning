...
from tqdm.notebook import tqdm  # Import standard tqdm for non-notebook environments
...
# print("\nFirst", num_samples_to_view, "samples in Train Dataset:")
# for i in range(num_samples_to_view):
#     print(train_anom_dataset[i])
#
# print("\nFirst", num_samples_to_view, "samples in Validation Dataset:")
# for i in range(num_samples_to_view):
#     print(val_anom_dataset[i])
#
# print("\nFirst", num_samples_to_view, "samples in Test Dataset:")
# for i in range(num_samples_to_view):
#     print(test_anom_dataset[i])
# #----------------------------------------------------------------------
...
test_anom_loader = data.DataLoader(test_anom_dataset, batch_size=64, shuffle=True, drop_last=True)

# test_anom_loader  = data.DataLoader(test_anom_dataset,  batch_size=64, shuffle=False, drop_last=False)
print("Checking a single batch from train_anom_loader")


# If the batch contains two elements, proceed with unpacking
# for i, batch in enumerate(train_anom_loader):
...
#         print()
#     else:
#         print(f"Batch {i+1} has unexpected format:", batch)
#
# for i, batch in enumerate(val_anom_loader):
#     if isinstance(batch, (tuple, list)) and len(batch) == 2:
#         data, labels = batch
#         print(f"Batch {i+1}")
#         print("Data:", data)
